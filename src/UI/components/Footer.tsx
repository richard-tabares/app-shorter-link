    ...
    <section className="footer">
      ...
      <section className="container w-4xl flex gap-2 justify-between">
        ...
        <section className='w-1/2 flex flex-col gap-3'>
          <h2 className='text-lg font-semibold'>Información & Ayuda</h2>
          <a href="" className='links'>Que es un acortador de Links?</a>
          <a href="" className='links'>Como funciona un acrotador de Links?</a>
          <a href="" className='links'>Como obtener el codigo QR de un Link?</a>
          <a href="" className='links'>Como acortar un Link?</a>

        </section>

      </section>
      <section className="text-center mt-6">
        <p className="text-sm">⚡Creado con React | Tailwind | Motion | Supabase</p>
        <p className="text-sm">Hecho con ♥️ por <a href="https://richardtabares.dev/" target='_blank' className='links'><strong>Richard Tabares</strong></a></p>
      </section>
    </section>
  )
}
